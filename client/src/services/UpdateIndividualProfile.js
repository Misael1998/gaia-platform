...
import { URL_UPDATE_INDIVIDUAL_PROFILE } from "../constants/urls";


export const updateIndividualData = async (
  ...
  try {
    ...
    const response = await axios.put(URL_UPDATE_INDIVIDUAL_PROFILE, payload);
