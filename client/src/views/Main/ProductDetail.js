        ...
        <div className="row">
          ...
          <div className="col-12">
            <p className="text-justify">
              ...
              ante sem, gravida ac sapien a, suscipit mattis risus. Vivamus non
              pulvinar enim. Fusce vel bibendum sapien. Cras ornare scelerisque
              lacus, vel fermentum quam maximus eu.
            </p>
          </div>
