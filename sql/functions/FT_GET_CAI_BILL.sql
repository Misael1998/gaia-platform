IF OBJECT_ID (N'FT_GET_CAI_BILL') IS NOT NULL
    DROP FUNCTION [FT_GET_CAI_BILL];
GO
CREATE FUNCTION [FT_GET_CAI_BILL] (@idRequest INT)
 RETURNS  @bill  TABLE
...
IF (@userTMP IS NOT NULL)
    ...
    SELECT    b.num_bill,     b.emission_date,
              ...
              cb.import,      cb.aliquot_rate, us.name+' '+us.lastname as nameClient
...
SELECT * from FT_GET_CAI_BILL(13)